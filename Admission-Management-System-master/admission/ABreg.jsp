...
<table width="800" height="350" border="0" align="center">
  <tr>
    <td valign="top"><p>&nbsp;</p>
      <p align="center" class="style1 style2" onClick="window.open('abRegAll.jsp','_self')"><u><strong>All</strong></u></p>
      <p align="center" class="style1" onClick="window.open('abRegDate.jsp','_self')"><strong><u>From one date to other date </u></strong></p>
      <p>&nbsp;</p></td>
  </tr>
</table>
