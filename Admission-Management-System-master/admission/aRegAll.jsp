...
String driver=application.getInitParameter("driver");
 ...
 if(rs1.next()){
  ...
  %>
      ...
      <p align="center" class="style4">A's Register
      ...
      <table width="801" height="95" border="1" cellpadding="5" cellspacing="0">
          <tr>
            ...
            <td width="112" ><div align="center" style="width:70;">Collection on the day (A's Share)</div> </td>
  ...
  if(rs.next()){
		  ...
		  <tr>
            ...
            <td><div align="center">&nbsp;</div></td>
            <td><div align="center">&nbsp;<%=rs.getFloat(2)*3/4%></div></td>
            <td><div align="center">&nbsp;<%=rs.getFloat(4)*3/4%></div></td>
            <td><div align="center">&nbsp;</div></td>
            <td><div align="center">&nbsp;</div></td>
            <td><div align="center">&nbsp;</div></td>
            <td><div align="center">&nbsp;</div></td>
		 ...
		 <tr>
            ...
            <td><div align="center"><%=rs.getFloat(7)*3/4%></div></td>
            <%
            if(rs.getString(3).equalsIgnoreCase("yes")){%>
            <td><div align="center" class="style3"> To Bank - <%=rs.getFloat(5)*3/4%></div></td>
            <%}else{%>
            <td><div align="center">&nbsp;</div></td><%}%>
            <td><div align="center">&nbsp;<%=rs.getFloat(2)*3/4%></div></td>
            <td><div align="center">&nbsp;<%=rs.getFloat(4)*3/4%></div></td>
