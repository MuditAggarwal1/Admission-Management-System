...
String admno= request.getParameter("admno");
        PreparedStatement pst = con.prepareStatement("select Name,Gender,lang,dob,national,religion,caste,cname,fname,foccup,mname,moccup,gname,goccup,addr,lastclass,oldschool,tcsubmit,tcno,tcdate,joinclass,medium,admdate,admno,prom,amt from admissions");
