...
pst = con.prepareStatement("select Name,Gender,lang,dob,national,religion,caste,cname,fname,foccup,mname,moccup,gname,goccup,addr,lastclass,oldschool,tcsubmit,tcno,tcdate,joinclass,medium,admdate,admno,prom,amt from admissions where admno between ? and ?");
 pst.setInt(1, num11);
  pst.setInt(2, num22);
 ...
 if(rs1.next()){
  %>
      ...
      <table width="1708" height="99" border="1" cellpadding="5" cellspacing="0">
          ...
          <%}else{%>
          <center><br>There is no such admission numbers.please check the admission numbers entered.</center>
          <%}%>
      </p>
      <p>&nbsp;  </p></td>
  </tr>
