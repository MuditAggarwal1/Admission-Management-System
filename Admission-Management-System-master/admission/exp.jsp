...
<table width="800" height="350" border="0" align="center">
  <tr>
    <td valign="top"><p align="center"><font size="4"><strong><font color="#AD003A">Your session has been Expired. Please login again. </font></strong></font></p>
      <TABLE border="0" cellPadding="10" width="186" align="center">
      <FORM  method="post" name="login" ONSUBMIT="return f1()" action="login.jsp">
       <TBODY>
          <TR>
