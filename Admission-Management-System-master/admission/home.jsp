...
<table width="800" height="350" border="0" align="center">
  <tr>
    <td valign="top"><p>&nbsp;</p>
      <p><span class="style2">Welcome to Admissions Management  System</span><BR>
        <BR>
      This  is Providing number of   facilities to the users.Before going to utilize these Services please study   Rules &amp; Regulations. Select the Options to   Proceed.</p>
      <p>&nbsp;</p>
    </td>
  </tr>
</table>
