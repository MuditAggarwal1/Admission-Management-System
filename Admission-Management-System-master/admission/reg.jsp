...
<table width="800" height="350" border="0" align="center">
  <tr>
    <td valign="top"><p align="center" class="style1 style2" onClick="window.open('classwise.jsp','_self')">&nbsp;</p>
      <p align="center" class="style1 style2" onClick="window.open('admRegister.jsp','_self')"><u>Admission Register</u></p>
      <p align="center" class="style1" onClick="window.open('ABreg.jsp','_self')"><strong><u>A &amp; B Register</u></strong></p>
      <p align="center" class="style1" onClick="window.open('Areg.jsp','_self')"><strong><u>A Register</u></strong></p>
      <p align="center" class="style1" onClick="window.open('Breg.jsp','_self')"><strong><u>B Register</u></strong></p>    </td>
  </tr>
</table>
