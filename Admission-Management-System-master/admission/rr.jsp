...
<table width="800" height="350" border="0" align="center">
  <tr>
    <td valign="top"><p>&nbsp;</p>
      <p class="style4">This is to inform that                              user must obey following                             Rules&amp;Regulations :</p>
      <p>1.If this is the first time to use the system, then it is must and should to initialise the following values</p>
      <ul>
      ...
      <p>2.The current system date must be maintained correctly.</p>
      <p>3.Only Internet Explorer must be used .</p>
      <p>4.Maximum size of the image should be 65 kb.If the image is more than this size, use softwares to compress it. </p>
      <p>4.If the Operating System is installed in C: drive ,then there is no problem.Otherwise, goto installed location of  tomcat > webapps > admission (our project name).In admission folder ,open WEB-INF folder,then open "web.xml".Now change the value of context parameter, named path to tomcat installed location in your system. </p>
      <p>&nbsp;</p>
      </td>
  </tr>
</table>
